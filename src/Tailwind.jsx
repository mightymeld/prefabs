...
export function Icon() {
  return (
    <button
      className='h-10 w-10 rounded-full flex items-center justify-center bg-sky-600 hover:bg-sky-700 transition duration-300 ease-in-out'
    >
      <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" fill="white" data-name="Layer 1" viewBox="0 0 24 24" width="24" height="24"><path d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,22A10,10,0,1,1,22,12,10.011,10.011,0,0,1,12,22ZM7,9.5C7,8.119,7.672,7,8.5,7S10,8.119,10,9.5,9.328,12,8.5,12,7,10.881,7,9.5Zm7,0c0-1.381.672-2.5,1.5-2.5S17,8.119,17,9.5,16.328,12,15.5,12,14,10.881,14,9.5ZM12,15a21.923,21.923,0,0,0,6.007-1c-.615,2.28-2.664,5-6,5S6.615,16.28,6,14A21.841,21.841,0,0,0,12,15Z" /></svg>
    </button>
  );
}
